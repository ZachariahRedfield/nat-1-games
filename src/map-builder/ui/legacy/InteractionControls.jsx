...
const BrushIcon = ({ className = "w-3.5 h-3.5" }) => (
...
const segmentedButtonClass = (isActive) =>
  `px-2 py-1 text-xs font-medium relative group inline-flex items-center justify-center gap-1 transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400 ${
    isActive
...
const toggleButtonClass = (isActive) =>
  `px-2.5 py-1 text-xs font-medium relative group inline-flex items-center gap-1 rounded-lg border transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400 ${
    isActive
...
const primaryButtonClass = (enabled) =>
  `px-2.5 py-1 text-xs font-medium relative group inline-flex items-center gap-1 rounded-lg border transition-all duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400 ${
    enabled
